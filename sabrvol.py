...
# excel file read
xl = pd.ExcelFile("Data/20160101_EUROSTOXX50.xlsx");
...
# set column name
euroTypes = euro.apply(lambda x: pd.api.types.infer_dtype(x.values));
...
plt.savefig('Graphics/FitImages/implievoleurostoxx.png')
...
plt.savefig('Graphics/FitImages/sabr.png')